...
test('19,1423.59 returns the 19th of this month this year at 1423, 59 seconds', (t) => {
  const epochMs = parse('19,1423.59')
  const expectedEpochMs = getTodaysDate({ date: 19, hours: 14, minutes: 23, seconds: 59, ms: 0 })
  t.is(epochMs, expectedEpochMs)
})
...
test('1908,1423.59 returns the 19th of august this year at 1423, 59 seconds', (t) => {
  const epochMs = parse('1908,1423.59')
  const expectedEpochMs = getTodaysDate({ month: 8, date: 19, hours: 14, minutes: 23, seconds: 59, ms: 0 })
  t.is(epochMs, expectedEpochMs)
})
