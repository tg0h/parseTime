...
test.before((t) => {
  const fakeNow = new Date(2022, 12, 31, 13, 10).getTime()
...
//   const expectedEpochMs = getUnixMs({ hours: 9, minutes: 23 }).getTime()
//   t.is(epochMs, expectedEpochMs)
// })

// test('19,900 returns the 19th of this month at 9am', (t) => {
//   const epochMs = parse('19,1423')
//   const expectedEpochMs = getUnixMs(14, 23).getTime()
//   t.is(epochMs, expectedEpochMs)
// })
// test('19,1423 returns the 19th of this month at 1423', (t) => {
//   const epochMs = parse('19,1423')
//   const expectedEpochMs = getUnixMs(15, 23).getTime()
//   t.is(epochMs, expectedEpochMs)
// })
//
